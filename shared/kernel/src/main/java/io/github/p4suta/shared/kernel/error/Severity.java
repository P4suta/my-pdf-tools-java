 ...
 *
 * <p>Invariant: {@link #WARN} pairs with {@code isClientFault() == true} (bad input/usage) and
 * {@link #ERROR} with {@code isClientFault() == false} (internal/environmental). {@link #INFO} is
 * reserved; no current kind uses it.
 */
