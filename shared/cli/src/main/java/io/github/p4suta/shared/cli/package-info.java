/**
 * Cross-app CLI scaffolding: the app-layer glue every p4suta command-line front end re-derives,
 * generalized from tate-yoko-pdf's best-of-breed Apache Commons CLI front end. This is the one
 * shared module deliberately allowed to write to {@code System.out}/{@code System.err} and to
 * depend on the Apache Commons CLI types; the kernel and observability layers stay stream-free.
 *
 * <ul>
 ...
 *       aggregating per-item failures through the shared {@link
 *       io.github.p4suta.shared.observability.ExceptionMapper} and returning the right sysexits
 *       exit code;
 ...
 * SLF4J facade. No app is migrated onto it here.
 */
@NullMarked
