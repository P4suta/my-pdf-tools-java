 ...
 * {@link io.github.p4suta.webapp.app.ReaperJob} schedule, and the request/response DTOs. The brains
 * ({@code application}) and adapters ({@code infrastructure}) below it never see Spring.
 */
@NullMarked
