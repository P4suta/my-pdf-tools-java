 ...
 * {@link java.util.List}, {@link java.io.IOException}); no Leptonica {@code Pix}, PDFBox or AWT
 * type ever crosses a port boundary, so the dependency is kept unidirectional and the adapters stay
 * swappable.
 */
@NullMarked
