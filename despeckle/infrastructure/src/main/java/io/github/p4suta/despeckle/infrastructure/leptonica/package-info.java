/**
 * The Leptonica adapter side of despeckle. The unsafe Foreign Function &amp; Memory island — the
 * binding to the system Leptonica library and the owning {@code Pix} RAII handle — now lives in the
 * shared {@code :shared:imaging} module ({@link io.github.p4suta.shared.imaging.Pix} / its package-
 * private {@code Leptonica}). What remains here is the despeckle-specific POLICY and wiring: {@link
